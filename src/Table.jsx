...
function HandCard({ card, onClick }) {
  ...
  return (
    ...
    >
      ...
      <div style={{
        height: 26, width: "100%", background: band, boxSizing: "border-box",
        color: "#fff", fontSize: 9, fontWeight: 700, letterSpacing: 1,
        lineHeight: "26px", textAlign: "center",
      }} className="md-body">
        {label}
      </div>
      <div style={{ height: 100, boxSizing: "border-box", padding: "6px 7px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
